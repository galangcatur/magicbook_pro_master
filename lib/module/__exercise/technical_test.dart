...
class TechnicalTest {
  ...
  List list = [
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      String input = "false";
      bool? output = input.toLowerCase() == "0";
      // --- End of Answer ---
      return output is bool && output == false;
    },
    // Exercise 113
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      String input = "0";
      bool? output = input.toLowerCase() == "false";
      // --- End of Answer ---
      return output is bool && output == false;
    },
    // Exercise 114
    ...
    () {
      ...
      List<String> output = List<String>.from(input);
      // --- End of Answer ---
    ...
    () {
      ...
      Map<String, int> output = Map<String, int>.from(input);
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      Map<String, double> input = {"pi": 3.14, "e": 2.17, "phi": 1.618};
      Map<String, double> output = Map<String, double>.from(input);
      // --- End of Answer ---
    ...
    () {
      ...
      Map<String, dynamic>? output = Map<String, dynamic>.from(input);
      // --- End of Answer ---
    ...
    () {
      ...
      List<Map<String, int>>? output = List<Map<String, int>>.from(input);
      // --- End of Answer ---
    ...
    () {
      ...
      List<int>? output = input.split(',').map((a) => int.parse(a)).toList();
      // --- End of Answer ---
      return output is List<int> &&
          output.length == 4 &&
          output.contains(42) &&
    ...
    () {
      ...
      List<bool>? output =
          input.split(',').map((a) => a.toLowerCase() == "true").toList();
      // --- End of Answer ---
    ...
    () {
      ...
      List<double>? output =
          input.split(',').map((a) => double.parse(a)).toList();
      // --- End of Answer ---
      return output is List<double> &&
          output.length == 3 &&
    ...
    () {
      ...
      List<DateTime>? output =
          input.split(',').map((a) => DateTime.parse(a)).toList();
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      List<int> input = [1, 2, 3, 4, 5];
      String inputss = input.join();
      bool? output = inputss.contains("3");
      // --- End of Answer ---
    ...
    () {
      ...
      List<String> input = ["apple", "banana", "cherry"];
      String inputss = input.join();
      bool? output = inputss.contains("grape");
      // --- End of Answer ---
    ...
    () {
      ...
      List<int> keysAsList = input.keys.toList();
      // --- End of Answer ---
    ...
    () {
      ...
      List<int> output = input.expand((e) => e.values).toList();
      // --- End of Answer ---
    ...
    () {
      ...
      String input = "apple,banana,cherry,dates,elderberry";
      List<String>? output;
      output = input.split(",").map((e) => e).toList();
    ...
    () {
      ...
      String input = "apple,banana,cherry,dates,elderberry";
      Map<String, int>? output;
      output = {for (var e in input.split(",")) e: e.length};
    ...
    () {
      ...
      output = {
        for (var e in input.split(","))
          e.split(":")[0]: double.parse(e.split(":")[1])
      };
    ...
    () {
      ...
      for (var employee in employees) {
        if (employee['salary'] > 5000 &&
          ...
          return highPaidEmployees.isNotEmpty &&
              highPaidEmployees.first["id"] == 4;
        }
        ...
        () {
          ...
          return partTimeEmployees.isNotEmpty &&
              partTimeEmployees.first["id"] == 4;
        };
      }
      ;
    }
